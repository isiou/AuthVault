...
# 全局单例实例
_qr_decoder_instance = None


def get_qr_decoder() -> QRCodeDecoder:
    """获取二维码解码器单例实例"""
    global _qr_decoder_instance
    if _qr_decoder_instance is None:
        _qr_decoder_instance = QRCodeDecoder()
    return _qr_decoder_instance
